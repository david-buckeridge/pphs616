...
# extract from jhu.cases, vector of cases by day from 2020-1-22 to most recent update (2020-03-06)
# for country in country.region
for (country.region in jhu.country.region) {
  this.country.cases = aggregateJHUCounts(jhu.cases[jhu.cases$Country.Region == country.region,])
  this.country.deaths = aggregateJHUCounts(jhu.deaths[jhu.deaths$Country.Region == country.region,])
  this.country.recovered = aggregateJHUCounts(jhu.recovered[jhu.deaths$Country.Region == country.region,])
  
  # place daily counts in list, indexed by country
  country.counts[[country.region]] = list("country" = country.region, 
                                          "cases"= this.country.cases, 
                                          "deaths" = this.country.deaths,
                                          "recovered" = this.country.recovered)
} # for jhu.country.region
